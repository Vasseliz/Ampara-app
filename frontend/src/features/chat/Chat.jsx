...
export default function Chat() {
  ...
  function renderizarMensagens() {
    ...
    if (!conversaAtual) {
      return (
        <p className="chat__state">Selecione uma conversa para começar.</p>
      );
    }

    if (!mensagens.length) {
      return (
        <p className="chat__state">Ainda não há mensagens nesta conversa.</p>
      );
    }
        ...
        <Card className="chat__conversation-picker">
          ...
          {loadingConversas ? (
            ...
            <p className="chat__state">
              Nenhuma conversa disponível para seu perfil.
            </p>
          )}
        </Card>
