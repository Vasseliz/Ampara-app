...
const styles = StyleSheet.create({
  ...
  bubble: { maxWidth: '82%', borderRadius: tokens.radius.lg, paddingHorizontal: tokens.spacing.md, paddingVertical: tokens.spacing.sm, gap: tokens.spacing.xs, ...tokens.shadow.card },
  mine: { backgroundColor: tokens.color.primaryDark, borderBottomRightRadius: tokens.radius.sm },
  theirs: { backgroundColor: tokens.color.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: tokens.color.border, borderBottomLeftRadius: tokens.radius.sm },
